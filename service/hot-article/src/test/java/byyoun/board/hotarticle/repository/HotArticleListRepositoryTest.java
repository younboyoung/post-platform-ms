...
class HotArticleListRepositoryTest {
    ...
    void addTest() throws InterruptedException {
        // given
        LocalDateTime time = LocalDateTime.of(2025, 6, 10, 0, 0);
        long limit = 3;
        ...
        // then
        List<Long> articleIds = hotArticleListRepository.readAll("20250610");
        ...
        assertThat(hotArticleListRepository.readAll("20250610")).isEmpty();
    }
}